export const MAP_INTENTS_TO_TAGS = {
  ...
  finance:{
    ask_price_reason:['O'],
    ask_price:['O', 'PriceType', 'CarSeries', 'Location', 'Source', 'CarBrand', 'DateTime'],
    ...
    compare_price:['O', 'CarSeries', 'PriceType', 'CarBrand', 'CarBrand', 'CarBody', 'CarAdj', 'Location'],
    ...
    consultant_price:['O', 'PriceEqual', 'PriceLower', 'PriceUpper', 
      'EngineTransmission', 'CarAdj', 'CarSeries', 'CarYear'],
  ...
  car_series:{
    ...
    ask_element:['O', 'CarElem', 'CarElemProp', 'CarSeries', 'CarBody', 'CarBrand', 'EngineFuel'],
    ask_property:['O', 'CarSeries', 'PurposeUsage', 'CarProp', 'CarPropValue', 'CarBrand', 
        'CarElem', 'CarElemProp', 'CarAdj', 'Source'],
    ...
    compare_property:['O', 'CarSeries', 'CarProp', 'CarYear', 'CarBrand', 'CarBody', 'Location'],
    consultant_buy:['O', 'CarAdj', 'Gender', 'CarSeries', 'PriceEqual','PriceUpper', 
        ...
        'Source', 'CarClass', 'DateTime', 'CarBody', 'CarBrand', 'EngineType', 
        'Location', 'Possesion', 'CarYear', 'MadeByCountry', 'Age', 'EngineTransmission', 'CarVersion'],
    ...
    review:['O', 'CarSeries', 'CarBrand', 'PriceEqual', 'Location', 'DateTime', 'MadeByCountry', 'Source'],
    review_element:['O', 'CarElem', 'CarElemProp', 'CarSeries', 'MadeByCountry', 'EngineFuel', 'CarBrand'],
    review_property:['O', 'CarProp', 'CarSeries', 'CarBrand'],
  ...
  car_brand:{
    ...
    ask_property:['O', 'CarBrand', 'CarBrandProp', 'DateTime'],
    compare:['O', 'CarBrand', 'Source', 'CarAdj', 'CarBrandProp'],
    compare_property:['O', 'CarBrandProp', 'CarBrand', 'Location'],
    review:['O', 'CarBrand'],
    review_property:['O'],
    sentiment:['O'],
